...
class Pre8():
    def __init__(self):
        ...
        self.network8 = './model/cnn-ocr-8bit'  # you can change the network here, such as cnn-ocr, cnn-ocr2, cnn-orc-test
        self.network7 = './model/cnn-ocr-7bit'
        ...
        self.length = 8
        _, self.arg_params, __ = mx.model.load_checkpoint(self.network8, 1)

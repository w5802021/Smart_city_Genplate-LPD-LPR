...
class Pre7():
    def __init__(self):
        ...
        self.network8 = './model/cnn-ocr-Xbit'  # you can change the network here, such as cnn-ocr, cnn-ocr2, cnn-orc-test
        self.network7 = './model/cnn-ocr-Xbit'
    ...
    def Run(self, num, filepath):  # a is the length of plate , b is file path
        ...
        return name_pre, name_all, accurace

    ...
    def batch_recognize_all_images(self):
        ...
        if len(self.subfolder_path) == 0:                         # 当直接进入只包含图片的路径时，进行处理
            ...
            if Reg_temp[len(Reg_temp) - 1] == Ability_k[0]:
                ...
                predx78 = predx.Pre7()  # 定义一个调用7位模型识别车牌的对象
                ...
                for i in range(0, len(Reg_path_file_list)):
                    ...
                    # "大型汽车后牌", "低速车牌", "各类摩托车牌", "挂车牌", "拖拉机牌","大型汽车前牌"，"小型汽车牌"
                    # "教练车牌",
                    if ((Reg_path_file_list[i] == A_caplat[0]) or (Reg_path_file_list[i] == A_caplat[1]) or
                        ...
                        (Reg_path_file_list[i] == A_caplat[4]) or (Reg_path_file_list[i] == A_caplat[9]) or
                        (Reg_path_file_list[i] == A_caplat[10]) or (Reg_path_file_list[i] == A_caplat[11])):
                        ...
                        for j in range(0, len(Reg_path_sondir_list)):
                            ...
                            if Reg_path_file_list[i] == A_caplat[11]:
                    ...
                    # "武警车牌"，"新能源-大车牌", "新能源-小车牌"
                    elif ((Reg_path_file_list[i] == A_caplat[8]) or (Reg_path_file_list[i] == A_caplat[13]) or
                        ...
                        # 识别车牌
                        e2e_img_list, e2e_orin_list, accurace = predx78.Run(8, Reg_path_sondir + "/")
                    ...
                    # "澳门出入境车牌"，"香港出入境车牌"，"领使馆车牌"，"警用车牌"，"军用车牌"
                        ...
                        # 识别车牌
                        e2e_img_list, e2e_orin_list, accurace = predx78.Run(7, Reg_path_sondir + "/")
